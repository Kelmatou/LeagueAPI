...
public class RankedEntry: Decodable {
    ...
    public init(leagueId: LeagueId, summonerId: SummonerId, summonerName: String, rank: String, leaguePoints: Int, series: Series?, wins: Int, losses: Int, hotStreak: Bool, veteran: Bool, freshBlood: Bool, inactive: Bool, queue: Queue) {
